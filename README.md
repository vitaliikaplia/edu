...
Легкий PHP-рушій для освітньої платформи з курсами та лекціями. Без бази даних, без фреймворків, без CMS. Контент зберігається у файловій системі, шаблони рендеряться через Twig, стилі компілюються з SCSS.
